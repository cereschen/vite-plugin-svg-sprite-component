...
function createPlugin(options) {
    ...
    return {
        transforms: [
            {
                test: function (_a) {
                    var path = _a.path, query = _a.query, isBuild = _a.isBuild;
                ...
                transform: function (_a) {
                    var source = _a.code, isBuild = _a.isBuild, path = _a.path;
                    return __awaiter(_this, void 0, void 0, function () {
                        var tmp, code, svgName, finalSymbolId, svgCode, svgNode, _b, width, height, childElements, removeAttrList, wrapNode, componentName, componentCode, htmlCode;
                        return __generator(this, function (_c) {
                            ...
                            if (!Reflect.has(svgNode.attribs, 'viewBox')) {
                                _b = svgNode.attribs, width = _b.width, height = _b.height;
